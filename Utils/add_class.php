...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare('INSERT INTO tb_class (name, teacher_id) VALUES (:name, :teacher_id)');
    $stmt->execute(['name' => $class_name, 'teacher_id' => $teacher_id]);
    ...
    <div class="right">
        ...
        <form action="" method="post" class="max-w-md">
            <div class="mb-4">
                ...
                <input type="text" name="class_name" id="class_name" class="mt-1 p-2 block w-full border border-gray-300 rounded-md" required>
            </div>
            <div class="mb-4">
            ...
            <div class="flex items-center justify-between">
                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Thêm lớp học</button>
